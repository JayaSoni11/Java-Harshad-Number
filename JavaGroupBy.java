...
public class JavaGroupBy{
    public static void main(String[] args) {
        ...
        Map<Integer, List<Boolean>> list2 = list.stream().
                collect(
                        Collectors.groupingBy(n->{if(n%10==0) return 10; else return 0;},
                        Collectors.mapping(n->{if(n%10==0) return true; else return false;},
                        Collectors.toList())              
                                ));
